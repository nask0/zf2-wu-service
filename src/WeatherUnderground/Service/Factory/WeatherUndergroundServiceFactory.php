...
use WeatherUnderground\Service\WeatherUndergroundService;
...
class WeatherUndergroundServiceFactory implements FactoryInterface
{
    ...
    public function createService(ServiceLocatorInterface $serviceLocator)
    {
        ...
        return new WeatherUndergroundService(new WeatherUndergroundConfig($config['weather-underground']), $serviceLocator->get('request'));
    }
}